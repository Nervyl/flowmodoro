...
function Header({ text }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "header--container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "header--text", children: text }) });
}
function Timer({ status }) {
  ...
  const formatTime = (time2) => {
    const minutes = Math.floor(time2 / 1e3 / 60);
    const seconds = Math.floor(time2 / 1e3 % 60);
  ...
  reactExports.useEffect(() => {
    chrome.storage.local.get(["colors"], (result) => {
      const currentColor = result.colors[status];
      setStyle(() => ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "timer--container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style, className: "timer--outer-circle" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "timer--inner-circle" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "timer--time", children: timeDisplay })
      ]
    }
  ) });
}
function Coming() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "coming--container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Coming" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Soon!" })
  ] });
}
function Navbar({
  selectedTab,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "navbar--container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-regular fa-clock" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-solid fa-list-check" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-solid fa-chart-simple" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-solid fa-gear" })
      }
    )
  ] });
}
function App() {
  const [selectedTab, setSelectedTab] = reactExports.useState("timer");
  const [status, setStatus] = reactExports.useState("break");
  reactExports.useEffect(
    () => chrome.runtime.onMessage.addListener((request) => {
  ...
  const mainElement = selectedTab === "timer" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Timer, { status }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Coming, {});
  console.log("App Rendered", status);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { text: headerText }),
    mainElement,
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { selectedTab, setSelectedTab })
  ] });
}
